package br.edu.ifsc.RentAI.modelo.imovel;
...
public class Imovel {
    ...
    public Imovel(Endereco endereco, int idImovel, String tipoImovel, String statusImovel, float metragem, int banheiros, int quartos, int vagas, String cpfCnpjProprietario, String creciCorretor) {
        this.endereco = endereco;
        this.idImovel = idImovel;
        this.tipoImovel = tipoImovel;
        this.statusImovel = statusImovel;
